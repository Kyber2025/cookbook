...
/
├── api/
│   └── list-contracts.ts                              # Lists contracts for the authenticated user
├── auth-sessions/
...
├── utils/
│   ├── resend.ts                                      # Resend API integration for email OTP retrieval
│   └── typesAndSchemas.ts                             # Type definitions and Zod validation schemas
├── intuned-resources/
│   ├── jobs/
